...
public class WeatherProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;  //For single item
            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;   //For list of items (multiple rows)
            case WEATHER:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        getContext().getContentResolver().notifyChange(uri, null);   //We have to pass original uri and not returnUri since it will not correctly notify our cursors of the change
        return returnUri;
    }
